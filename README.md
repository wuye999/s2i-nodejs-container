...
- **RHEL based image**
  ...
  These images are available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhel8/nodejs-22).
  To download it run:

  ```
  $ podman pull registry.access.redhat.com/rhel8/nodejs-22
  ```
  ...
  $ make build TARGET=rhel8 VERSIONS=22
  ```
...
- **CentOS Stream based image**
  ...
  ```
  $ podman pull quay.io/sclorg/nodejs-22-c9s
  ```
...
- **RHEL based image**
  ...
  $ cd s2i-nodejs-container
  $ git submodule update --init
  $ make test TARGET=rhel8 VERSIONS=22
  ```
